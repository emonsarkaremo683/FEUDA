  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <AdminModal 
        ...
        title={isEditing ? 'Configure Merchant' : 'Register Merchant'}
        subtitle="Manage Payment Gateway Infrastructure"
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <select value={form.type} onChange={e => setForm({...form, type: e.target.value})} className="w-full bg-[#0f1115] border border-white/10 rounded-2xl px-6 py-4 text-white outline-none font-bold appearance-none">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button type="submit" className="flex-1 py-4 bg-orange-600 text-white font-black uppercase text-[10px] rounded-2xl shadow-lg shadow-orange-500/20 active:scale-95 transition-all">{isEditing ? 'Commit' : 'Initialize'}</button>
          </div>
        </form>
      </AdminModal>
      ...
      <AdminConfirmDialog 
        ...
        title="Purge Payment Gateway"
        message={`Are you sure you want to permanently remove the "${confirmDelete.name}" payment method? This will immediately disable it for all customers.`}
